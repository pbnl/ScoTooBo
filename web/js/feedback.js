    ...
    returnMethods = {
        ...
        send: function( adapter ) {
            ...
            adapter.send( data, function( success ) {
                ...
                /* remove highlighted and blackouted elements */
                $('.feedback-highlighted').each(function(i, obj) {
                    $( this ).remove();
                });
...
window.Feedback.Form = function( elements ) {
    ...
    this.elements = elements || [{
        type: "textarea",
        name: "Text",
        label: "Beschreibe uns hier kurz dein Anliegen (den Fehler, dein Lob, deinen Wunsch)",
        required: false
...
window.Feedback.Screenshot.prototype.start = function( modal, modalHeader, modalFooter, nextButton ) {
    ...
    if ( this.h2cDone ) {
        ...
        this.dom.appendChild( element("p", "Hebe ggf. noch wichtige Bereiche hervor und blende persönliche aus.") ); /* "Highlight or blackout important information" */
