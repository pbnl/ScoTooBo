...
// script onload function to provide support for IE as well
    ...
    window.Feedback = function( options ) {
        ...
        options.feedbackText = options.feedbackText || "Please describe the issue you are experiencing";
    ...
    window.Feedback.Form = function( options, elements ) {

        this.elements = elements || [{
            type: "textarea",
            name: "Text",
            label: options.feedbackText,
            required: false
        }];
